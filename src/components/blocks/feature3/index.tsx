              ...
              {section.items?.map((item, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <motion.div
                        className={`flex gap-4 rounded-lg px-6 py-4 text-left border transition-all duration-200 lg:block lg:px-4 ${isActive
                      ...
                      >
                        ...
                        <div className="flex-1">
                          <motion.h3
                            className={`mb-2 font-medium lg:mt-4 transition-colors duration-200 ${isActive ? "text-blue-600/90" : "text-foreground"
                              }`}
                            animate={{
